      ...
      >
        ...
        <div className="af-side-nav">
          <div className="af-side-section">
            ...
            <Link href="/" className="af-side-link active" title="Dashboard" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
          ...
          <div className="af-side-section">
            ...
            <Link href="/org" className="af-side-link" title="Organization Setup" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/assets" className="af-side-link" title="Assets" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
          ...
          <div className="af-side-section">
            ...
            <Link href="/allocation" className="af-side-link" title="Allocation & Transfer" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/booking" className="af-side-link" title="Resource Booking" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/maintenance" className="af-side-link" title="Maintenance" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/reports" className="af-side-link" title="Reports & Analytics" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/audit" className="af-side-link" title="Audit & Compliance" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/notifications" className="af-side-link" title="Notifications" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
