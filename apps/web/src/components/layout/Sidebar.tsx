...
export default function Sidebar({ collapsed, setCollapsed, open, setOpen }: SidebarProps) {
  ...
  const totalAssets = kpis?.totalAssets ?? 180;
  const totalPeople = employees?.length ?? 122;
  const totalDepts = departments?.length ?? 5;

  // Scale font size down as width decreases from 240px to 180px
  const fontSize = collapsed ? 14 : Math.max(11, Math.min(14, 11 + (width - 180) * (3 / 60)));
      ...
      >
        ...
        <div className="af-side-nav">
          <div className="af-side-section">
            ...
            <Link href="/" className={`af-side-link ${pathname === '/' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
          ...
          <div className="af-side-section">
            ...
            <Link href="/org" className={`af-side-link ${pathname === '/org' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/assets" className={`af-side-link ${pathname === '/assets' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
          ...
          <div className="af-side-section">
            ...
            <Link href="/allocation" className={`af-side-link ${pathname === '/allocation' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/booking" className={`af-side-link ${pathname === '/booking' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/maintenance" className={`af-side-link ${pathname === '/maintenance' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/reports" className={`af-side-link ${pathname === '/reports' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/audit" className={`af-side-link ${pathname === '/audit' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/notifications" className={`af-side-link ${pathname === '/notifications' ? 'active' : ''}`} style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
          ...
          <div className="af-side-footer" style={{ transition: 'opacity 0.2s' }}>
            <div className="af-sidebar-stats">
              <div className="af-sidebar-stat">
                <span className="af-sidebar-stat-val">{totalAssets.toLocaleString()}</span>
                <span className="af-sidebar-stat-label">Assets</span>
              </div>
              <div className="af-sidebar-stat">
                <span className="af-sidebar-stat-val">{totalPeople.toLocaleString()}</span>
                <span className="af-sidebar-stat-label">People</span>
              </div>
              <div className="af-sidebar-stat">
                <span className="af-sidebar-stat-val">{totalDepts.toLocaleString()}</span>
