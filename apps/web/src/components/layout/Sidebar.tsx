      ...
      >
        ...
        <div className="af-side-nav">
          <div className="af-side-section">
            ...
            <Link href="/" className="af-side-link active" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
          ...
          <div className="af-side-section">
            ...
            <Link href="/org" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/assets" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
          ...
          <div className="af-side-section">
            ...
            <Link href="/allocation" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/booking" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/maintenance" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/reports" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/audit" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
            ...
            <Link href="/notifications" className="af-side-link" style={{ fontSize: `${fontSize}px` }} onClick={() => setOpen(false)}>
              <span className="af-side-icon">
